...
export default class Resources extends EventEmitter
{
    constructor()
    {
        ...
        this.loader.load([
            ...
            { name: 'matcapOrange', source: './models/matcaps/metal.png', type: 'texture' },//changed to metal from orange
            { name: 'matcapRed', source: './models/matcaps/red.png', type: 'texture' },
            { name: 'matcapWhite', source: './models/matcaps/white.png', type: 'texture' },
            { name: 'matcapGreen', source: './models/matcaps/emeraldGreen.png', type: 'texture' },//changed to emeraldGreen from green
